$(window).load(function(){
	...
	*/ 
    var chapNameSet=[
		//['생략','1차시 1페이지','1차시 2페이지'],
        //['생략','2차시 1페이지','2차시 2페이지'], ...
		
        [], // 생략
        ['','인트로','들어가기','만화웹툰 분야 표준계약서','아웃트로'], //1페이지
        ['','인트로','들어가기','저작권과 라이선스 이해하기(1)','아웃트로'],
        ['','인트로','들어가기','저작권과 라이선스 이해하기(2)','아웃트로'],
        ['','인트로','들어가기','IP 확장하는 법','아웃트로'],
        ['','인트로','들어가기','연재와 저작권 이용의 대가 정하기','아웃트로'],
        ['','인트로','들어가기','원고 창작 과정에서 제작사와 원활하게 소통하기','아웃트로'],
        ['','인트로','들어가기','계약의 종료와 분쟁 해결하기','아웃트로'],
