...
subjectNameSet[1][1]="산업혁명 히스토리";
subjectNameSet[1][2]="산업혁명 개념도";
subjectNameSet[1][3]="글로벌 기업분석";

subjectNameSet[2]=new Array();
subjectNameSet[2][1]="MAGA TREND : 공유경제";
subjectNameSet[2][2]="금융(대출)의 변화, P2P";
subjectNameSet[2][3]=" FANG은 끝없이 갈 수 있을까?";

subjectNameSet[3]=new Array();
subjectNameSet[3][1]="5G 시대";
subjectNameSet[3][2]="통신업, 의약업 등 사업분석";

subjectNameSet[4]=new Array();
subjectNameSet[4][1]="포트폴리오 이론 : 분산투자, 상관계수";
subjectNameSet[4][2]="부동산 현황";
...
targetNameSet[1][1]="산업혁명의 역사를 살펴볼 수 있다.";
targetNameSet[1][2]="산업혁명의 개념도를 정리할 수 있다.";
targetNameSet[1][3]="산업혁명을 통한 글로벌 기업들의 성장도를 분석할 수 있다.";

targetNameSet[2]=new Array();
targetNameSet[2][1]="공유경제의 의미와 중요성을 이해할 수 있다.";
targetNameSet[2][2]="온라인투자연계를 통한 금융시장의 변화를 파악할 수 있다.";
targetNameSet[2][3]="FANG이 주도하는 IT업계의 현재와 미래를 살펴볼 수 있다.";

targetNameSet[3]=new Array();
targetNameSet[3][1]="국내 5G의 발전으로 생긴 변화를 살펴볼 수 있다.";
targetNameSet[3][2]="통신업, 의약업 등의 사업분석을 해볼 수 있다.";

targetNameSet[4]=new Array();
targetNameSet[4][1]="투자를 위한 포트폴리오 이론을 이해할 수 있다.";
targetNameSet[4][2]="해외투자를 위한 부동산 현황을 살펴볼 수 있다.";
