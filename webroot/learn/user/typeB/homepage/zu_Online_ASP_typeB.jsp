			...
			<div class="layerpopup-box">
				<div style="text-align: center">
					...
					<div class="content-box">
						...
						<c:if test="${nowDate > '20230725235959'}">
						<p>
							<strong>■ 2023년 한국예술인복지재단 온라인 교육 종료</strong><br><br>
							2023년 한국예술인복지재단 온라인 교육에 참여해주셔서 감사드립니다.<br>
							2024년 온라인 교육 시작 시,<br>
							한국예술인복지재단 누리집에 안내될 예정이니 많은 참여부탁드립니다.<br>
							(2024년 3월 중순 예정)<br><br>
							안내 경로: 한국예술인복지재단 누리집(www.kawf.kr) ▶ 알림/소식 ▶ 공지사항<br><br>
						</p>
						</c:if>
					</div>
