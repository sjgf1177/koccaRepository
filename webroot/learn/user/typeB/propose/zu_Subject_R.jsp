...
<script type="text/javascript">
    function whenPreShow(url, subj, d_wj_classkey) {
        ...
        open_window("openShow",url,"100","100","${subjectPreview.d_prewidth}","578","","","",true,true);
    }
                                    ...
                                    <div class="sub_course_view_wrap">
                                        <div class="lesson_bg_box">
                                            ...
                                            <div class="info_box d-inblock">
                                                <dl class="d-flex">
                                                    <dt>제작년도</dt>
                                                    <dd>${subjectPreview.d_crdate}</dd>
                                                </dl>
                                                <dl class="d-flex">
                                                    <dt>차시수</dt>
                                                    <dd>${subjectPreview.d_lesson_cnt}차시</dd>
                                                </dl>
                                                <dl class="d-flex">
                                                    <dt>러닝타임</dt>
                                                    <dd>${subjectPreview.d_running_time}</dd>
                                                </dl>
                                                <dl class="d-flex">
                                                    <dt>강사명</dt>
                                                    <dd> ${subjectPreview.d_tutor2}</dd>
                                                </dl>
                                            </div>
                                        ...
                                        <div class="info_box">
                                            <table>
                                                ...
                                                <tbody>
                                                <c:if test="${not empty subjectPreview.d_edumans}">
                                                    <tr>
                                                        <th>교육대상</th>
                                                        <td>
                                                            <i class="icon_chk"></i>
                                                ...
                                                <c:if test="${not empty subjectPreview.d_memo}">
                                                    <tr>
                                                        <th>강의교재/참고</th>
                                                        <td>
                                                            <i class="icon_chk"></i>
