...
public class BoardAdminBean {
    ...
    public int insertBoard(RequestBox box) throws Exception {
        ...
        System.out.println(" BoardAdmin content = " + v_content);
    ...
    public int replyBoard(RequestBox box) throws Exception {
        ...
        try {
            ...
            //pstmt2.setString(index++, v_content);
    ...
    public int updateBoard(RequestBox box) throws Exception {
        ...
        String v_content = StringUtil.removeTag(box.getString("p_content"));
        Vector<String> v_savefile = box.getVector("p_savefile"); //선택삭제파일
        Vector<String> v_filesequence = box.getVector("p_fileseq"); //선택삭제파일 sequence
