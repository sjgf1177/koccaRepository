...
public class SubjectClassifyBean {
    ...
    public ArrayList selectCourseInfo(RequestBox box) throws Exception {
        ...
        try {
            ...
            sql.append("/* com.credu.course.SubjectClassifyBean() selectCourseInfo (과정 정보 조회) */                                                                \n");
    ...
    public ArrayList selectCourseNextList(RequestBox box) throws Exception {
        ...
        try {
            ...
            sql.setLength(0);
            sql.append("/* com.credu.course.SubjectClassifyBean() selectCourseNextList (과정 태그 조회) */                                                            \n");
            ...
            sql.setLength(0);
            sql.append("/* com.credu.course.SubjectClassifyBean() selectCourseNextList (연계 과정 목록 조회) */                                                        \n");
