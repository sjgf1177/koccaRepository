 ...
 */
public class KSulmunCommonUserBean {


    public KSulmunCommonUserBean() {}
    ...
    */
    public ArrayList SelectUserList(RequestBox box) throws Exception {
        ...
        String v_grcode = box.getStringDefault("s_grcode", SulmunCommonBean.DEFAULT_GRCODE);
			...
			sql+= " and subj = a.subj and sulpapernum = a.sulpapernum and userid = "+SQLString.Format(s_userid)+" ) issul "; 
