...
public class SulmunTargetUserBean {
    ...
    public int InsertSulmunUserResult(RequestBox box) throws Exception {
        ...
        System.out.println("v_answers : " + v_answers);
        ...
        try {
            ...
            if (isOk == 2) {
                ...
                //System.out.println("대상자설문  결과 등록여부  체크:"+sql1);
                //System.out.println("1, v_subj:"+v_subj+"/2, v_grcode:"+v_grcode+"/3, v_gyear:"+v_gyear+"/4, v_subjseq:"+v_subjseq+"/5, v_sulpapernum:"+v_sulpapernum+"/6, v_userid:"+v_userid);
                ...
                System.out.println("v_sulpapernum : " + v_sulpapernum);
                ...
                try {
                    ...
                    if (!rs.next()) { //     과거에 등록된 userid 를 확인하고 없을 경우에만 등록          
                        ...
                        // tz_suleach 결과의 subj에는 ALL 을 넣고 gubun 에는 'TARGET'을 넣음
                        isOk1 = InsertTZ_suleach(connMgr, "ALL", v_grcode, v_gyear, v_subjseq, v_sulpapernum, v_userid, v_sulnums, v_answers, v_luserid);
                        System.out.println("isOk2 : " + isOk1);

                        updateTZ_sulmail(connMgr, v_subj, v_grcode, v_gyear, v_subjseq, v_sulpapernum, v_userid, v_sulnums, v_answers, v_luserid);
                        System.out.println("isOk3 : " + isOk1);
                    }
    ...
    public int InsertSulmunUserResult2(RequestBox box) throws Exception {
        ...
        ArrayList<ArrayList<DataBox>> blist = null;
        ...
        try {
            ...
            for (int i = 0; i < blist.size(); i++) {
                ArrayList<DataBox> list = (ArrayList<DataBox>) blist.get(i);
    ...
    public int updateTZ_sulmail(DBConnectionManager connMgr, String p_subj, String p_grcode, String p_gyear, String p_subjseq, int p_sulpapernum, String p_userid, String p_sulnums, String p_answers, String p_luserid) throws Exception {
     ...
     * @return int
     */
    public int InsertTZ_suleach(DBConnectionManager connMgr, String p_subj, String p_grcode, String p_gyear, String p_subjseq, int p_sulpapernum, String p_userid, String p_sulnums, String p_answers, String p_luserid) throws Exception {
     ...
     * @return ArrayList
     */
    public ArrayList<DataBox> selectSulmunTargetList(RequestBox box) throws Exception {
        DBConnectionManager connMgr = null;
        ListSet ls = null;
        ArrayList<DataBox> list = null;
        DataBox dbox = null;
