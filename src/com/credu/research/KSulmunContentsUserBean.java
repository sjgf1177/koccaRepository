 ...
 */
public class KSulmunContentsUserBean {

    public KSulmunContentsUserBean() {
    }
    ...
    public ArrayList<DataBox> SelectUserList(DBConnectionManager connMgr, RequestBox box) throws Exception {
        ...
        try {
            ...
            sql = " select * from (select rownum rnum, a.grcode, a.subj, a.subjseq, a.sulpapernum, a.sulpapernm, ";
            sql += " 	a.year, a.totcnt, a.sulnums, a.sulmailing, a.sulstart, a.sulend ";
            sql += " from tz_sulpaper a ";
            sql += " where a.subj = 'REGIST' ";
            sql += " order by a.subj, a.sulpapernum desc) where rnum=1";
    ...
    public ArrayList<DataBox> SelectUserList(RequestBox box) throws Exception {
        ...
        try {
            ...
            sql += "  from tz_sulpaper a ";
            sql += "   where a.subj   = 'REGIST'  and rownum=1 ";
