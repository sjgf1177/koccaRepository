...
//=========운영자인화면 리스트 시작=========
	...
	* @throws Exception
	*/
	public ArrayList selectListBriefing(RequestBox box) throws Exception {
		...
		try {
			...
			bodySql.append(" AND     TABSEQ = '").append(v_tabseq).append("' \n ");
	...
	* @throws Exception
	*/
	public int insertBriefing(RequestBox box) throws Exception {
		...
		try {
           ...
           isOk2 = this.insertUpFile(connMgr,v_tabseq, v_seq, box);  // 파일 첨부
	...
	* @throws Exception
	*/
	 public int updateBriefing(RequestBox box) throws Exception {
		DBConnectionManager connMgr = null;
		PreparedStatement pstmt = null;
	...
	* @throws Exception
	*/
	public int deleteBriefing(RequestBox box) throws Exception {
		DBConnectionManager connMgr = null;
		PreparedStatement pstmt = null;
		String sql = "";
		int isOk = 0;
	...
	* @throws Exception
	*/
   public DataBox selectViewBriefing(RequestBox box) throws Exception {
