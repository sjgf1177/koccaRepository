 ...
 * @author : S.W.Kang
 */
public class OffPlanNoteBean {
	private	static final String	FILE_TYPE =	"p_file";			//		파일업로드되는 tag name
	private	static final int FILE_LIMIT	= 10;					//	  페이지에 세팅된 파일첨부 갯수
	private	ConfigSet config;
	private	int	row;
	private int tabseq = 1207;									//   통합게시판 테이블 번호
	private String type = "PN";									//   통합게시판 테이블 타입

	public OffPlanNoteBean() {
		try{
	...
	*/
	public ArrayList selectList(RequestBox box) throws Exception	{
		...
		try	{
			...
			head_sql.append("        , (select count(*) from tz_boardfile where tabseq = a.tabseq and seq = a.seq) upfilecnt \n ");
...
//	   System.out.println("---- Notice Detail Page (selectNotice) -------");
		DBConnectionManager	connMgr	= null;
		ListSet	ls = null;
...
//		 System.out.println("---- Update Notice Te Start !!! -------");
		DBConnectionManager	connMgr	= null;
		Connection conn	= null;
		PreparedStatement pstmt1 = null;
		String sql1	= "";
