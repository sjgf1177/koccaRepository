...
// Source File Name:   DamunCommonResultBean.java
...
public class DamunCommonResultBean
{

    public DamunCommonResultBean()
    {
    }
        ...
        throws Exception
    {
        ...
        System.out.println("v_action" + v_action);
        try
        {
        ...
        throws Exception
    {
        ...
        try
        {
            v_damunnums = getSulnums(connMgr, v_grcode, v_gubun, v_damunpapernum);
            QuestionExampleDataList = getSelnums(connMgr, v_gubun, v_grcode, v_damunnums);
            v_answers = getDamunAnswers(connMgr, v_grcode, v_gyear, v_grseq, v_gubun, v_damunpapernum, v_subjseq, v_company, v_jikwi, v_jikun, v_workplc);
            v_obanswers1 = getDamunOBAnswers(connMgr, v_grcode, v_gyear, v_grseq, v_gubun, v_damunpapernum, "1", v_subjseq, v_company, v_jikwi, v_jikun, v_workplc);
            v_obanswers2 = getDamunOBAnswers(connMgr, v_grcode, v_gyear, v_grseq, v_gubun, v_damunpapernum, "2", v_subjseq, v_company, v_jikwi, v_jikun, v_workplc);
            v_obanswers3 = getDamunOBAnswers(connMgr, v_grcode, v_gyear, v_grseq, v_gubun, v_damunpapernum, "3", v_subjseq, v_company, v_jikwi, v_jikun, v_workplc);
            ...
            v_studentcount = getStudentCount(connMgr, v_grcode, v_gyear, v_grseq, v_gubun, v_subjseq, v_damunpapernum, v_company, v_jikwi, v_jikun, v_workplc);
            v_studentobcount = getStudentOBCount(connMgr, v_grcode, v_gyear, v_grseq, v_gubun, v_subjseq, v_damunpapernum, v_company, v_jikwi, v_jikun, v_workplc);
        ...
        throws Exception
    {
        ...
        try
        {
            sql = "  select b.fanswers, b.sanswers ";
            sql = sql + "    from ";
            sql = sql + "         tz_damuneach    b, ";
            sql = sql + "         tz_member     d  ";
            sql = sql + "   where b.userid  = d.userid  ";
            ...
            if(!p_company.equals("ALL"))
                sql = sql + "     and d.comp = " + SQLString.Format(p_company);
        ...
        throws Exception
    {
        ...
        {
            sql = "  select b.fanswers, b.sanswers ";
            sql = sql + "    from tz_subjseq    a, ";
            sql = sql + "         tz_damuneach    b, ";
            sql = sql + "         tz_member     d  ";
            sql = sql + "   where a.subj    = b.subj  ";
            sql = sql + "     and a.year    = b.year  ";
            sql = sql + "     and a.subjseq = b.subjseq  ";
            sql = sql + "     and b.userid  = d.userid  ";
            if(!p_grcode.equals("ALL"))
                sql = sql + " and b.grcode  = " + SQLString.Format(p_grcode);
            if(!p_gyear.equals("ALL"))
                sql = sql + " and b.year   = " + SQLString.Format(p_gyear);
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            sql = sql + "     where b.obuserid  = d.userid  ";
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            sql = sql + "     and a.year    = b.year  ";
            sql = sql + "     and a.subjseq = b.subjseq  ";
            sql = sql + "     and b.obuserid  = d.userid  ";
            sql = sql + "     and b.relation = " + SQLString.Format(p_relation);
            if(!p_company.equals("ALL"))
                sql = sql + "     and d.comp = " + SQLString.Format(p_company);
            if(!p_jikwi.equals("ALL"))
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            sql = sql + "         tz_member     c  ";
            sql = sql + "   where b.userid  = c.userid   ";
            sql = sql + "     and b.subj  = " + SQLString.Format(p_subj);
            sql = sql + " and b.damunpapernum   = " + SQLString.Format(p_damunpapernum);
            if(!p_grcode.equals("ALL"))
                sql = sql + " and b.grcode  = " + SQLString.Format(p_grcode);
            ...
            if(!p_grseq.equals("ALL") && !p_company.equals("ALL"))
                sql = sql + "     and c.comp = " + SQLString.Format(p_company);
            if(!p_jikwi.equals("ALL"))
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            sql = sql + "         tz_member     c  ";
            sql = sql + "   where b.obuserid  = c.userid   ";
            sql = sql + "     and b.subj  = " + SQLString.Format(p_subj);
            sql = sql + " and b.damunpapernum   = " + SQLString.Format(p_damunpapernum);
            if(!p_grcode.equals("ALL"))
                sql = sql + " and b.grcode  = " + SQLString.Format(p_grcode);
                ...
                for(; ls.next(); ls2.close())
                {
                    ...
                    for(ls2 = connMgr.executeQuery(sql2); ls2.next(); list.add(dbox2))
                    {
                        ...
                        if(ls3.next())
                        {
                            ...
                            String fselpoint = "";
                            String sselpoint = "";
                            System.out.println(ls3.getString("fanswers"));
                            ...
                            System.out.println(ls3.getString("sanswers"));
