 ...
 */
public class JindanBean {
    public final static String SPLIT_COMMA = ",";
    public final static String SPLIT_COLON = ":";

    public final static String PTYPE        = "0062"; // 진단분류
    public final static String MIDDLE_EXAM  = "M";    // 중간진단
    public final static String FINAL_EXAM   = "T";    // 최종진단
    public final static String ONLINE_EXAM  = "O";    // 온라인테스트

    public final static String JINDAN_TYPE            = "0063";   // 진단문제분류
    ...
    public final static String JINDAN_LEVEL   = "0064";   // 문제난이도
    public final static String TOP          = "1";      // 상
    public final static String MIDDLE       = "2";      // 중
    public final static String LOW          = "3";      // 하

    public final static String PAPER_GUBUN  = "0065";   // 문제지유형
    public final static String GENERAL      = "1";      // 일반진단
    public final static String REALTIME     = "2";      // 실시간진단
