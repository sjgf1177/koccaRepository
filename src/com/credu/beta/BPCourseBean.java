    ...
    */
    public ArrayList selectCourseList(RequestBox box) throws Exception {
        ...
        try {
			...
			head_sql = " select a.subj, a.subjnm, a.isonoff, a.eduurl, a.preurl, ";
			head_sql+= "        a.conturl, b.compnm, a.cpapproval                ";
			body_sql+= " from tz_subj a, tz_comp b                               ";
			body_sql+= " where  1=1                                              ";
            ...
            if(!v_year.equals("") && !v_year.equals("ALL")){
				body_sql += " and substring(a.indate,1,4) = " + StringManager.makeSQL(v_year);
            }
            else if(v_year.equals("")){
				body_sql += " and substring(a.indate,1,4) = " + StringManager.makeSQL(FormatDate.getDate("yyyy"));
            }
            
            //베타업체 검색
            if(!v_cp.equals("") && !v_cp.equals("ALL")){
				body_sql += " and a.producer = " + StringManager.makeSQL(v_cp);
				body_sql += " and a.producer = b.comp ";
    ...
    */
    public DataBox SelectSubjectData(RequestBox box) throws Exception {
        ...
        try {
			...
			sql+=  "		a.isoutsourcing,	isnull(a.cpsubj,'') cpsubj,	  a.conturl,  a.eduprice,     ";
    ...
    */
    public String getMaxSubjcode(DBConnectionManager connMgr, String v_upperclass, String v_middleclass) throws Exception {
        ...
        try {
			...
			// 수정일 : 05.11.04 수정자 : 이나연 _ substr 수정
//			sql = " select max(substr(subj,7,4)) maxsubj";
			sql = " select max(substring(subj,7,4)) maxsubj";
