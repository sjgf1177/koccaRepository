...
// Source File Name:   DamunSubjQuestionServlet.java
...
import com.credu.multiestimate.DamunSubjQuestionBean;
import com.credu.multiestimate.ScaleBean;
import com.credu.system.AdminUtil;

@WebServlet("/servlet/controller.multiestimate.DamunSubjQuestionServlet")
public class DamunSubjQuestionServlet extends HttpServlet
    implements Serializable
{

    public DamunSubjQuestionServlet()
    {
    }
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(!AdminUtil.getInstance().checkRWRight("DamunSubjQuestionServlet", v_process, out, box))
                return;
            ...
            if(v_process.equals("DamunQuestionPoolPage"))
                performDamunQuestionPoolPage(request, response, box, out);
            else
            if(v_process.equals("QuestionPoolListPage"))
                performQuestionPoolListPage(request, response, box, out);
            else
            if(v_process.equals("DamunQuestionInsertPool"))
                performDamunQuestionInsertPool(request, response, box, out);
        }
        catch(Exception ex)
        {
        ...
        throws Exception
    {
        try
        {
            ...
            String v_return_url = "/learn/admin/multiestimate/za_DamunSubjQuestion_L.jsp";
            DamunSubjQuestionBean bean = new DamunSubjQuestionBean();
        ...
        throws Exception
    {
        ...
        {
            request.setAttribute("requestbox", box);
            String v_return_url = "/learn/admin/multiestimate/za_DamunSubjQuestion_I.jsp";
        ...
        throws Exception
    {
        ...
        {
            request.setAttribute("requestbox", box);
            String v_return_url = "/learn/admin/multiestimate/za_DamunSubjQuestion_I2.jsp";
            ScaleBean sbean = new ScaleBean();
            ArrayList list1 = sbean.selectScaleGubunExample(box);
            request.setAttribute("ScaleQuestionExampleData", list1);
            ServletContext sc = getServletContext();
        ...
        throws Exception
    {
        ...
        {
            request.setAttribute("requestbox", box);
            String v_return_url = "/learn/admin/multiestimate/za_DamunSubjQuestion_U.jsp";
            DamunSubjQuestionBean bean = new DamunSubjQuestionBean();
        ...
        throws Exception
    {
        ...
        {
            request.setAttribute("requestbox", box);
            String v_return_url = "/learn/admin/multiestimate/za_DamunSubjQuestion_U2.jsp";
            DamunSubjQuestionBean bean = new DamunSubjQuestionBean();
        ...
        throws Exception
    {
        try
        {
            String v_url = "/servlet/controller.multiestimate.DamunSubjQuestionServlet";
            DamunSubjQuestionBean bean = new DamunSubjQuestionBean();
    ...
    public void performDamunQuestionPoolPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out)
        throws Exception
    {
        try
        {
            request.setAttribute("requestbox", box);
            String v_return_url = "/learn/admin/multiestimate/za_DamunSubjQuestionPool_I.jsp";
            DamunSubjQuestionBean bean = new DamunSubjQuestionBean();
            ArrayList list1 = bean.selectQuestionPool(box);
            request.setAttribute("DamunQuestionPool", list1);
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher(v_return_url);
            rd.forward(request, response);
        }
        ...
        {
            ErrorManager.getErrorStackTrace(ex, out);
            throw new Exception("performDamunQuestionPoolPage()\r\n" + ex.getMessage());
        }
    }

    public void performQuestionPoolListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out)
        throws Exception
    {
        try
        {
            ...
            request.setAttribute("DamunQuestionPool", list);
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher(v_return_url);
            rd.forward(request, response);
        }
    ...
    public void performDamunQuestionInsertPool(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out)
        throws Exception
    {
        try
        {
            ...
            String v_msg = "";
            box.put("p_process", "DamunQuestionPoolPage");
            box.put("p_action", "go");
            AlertManager alert = new AlertManager();
            if(isOk > 0)
            {
        ...
        {
            ErrorManager.getErrorStackTrace(ex, out);
            throw new Exception("performDamunQuestionInsertPool()\r\n" + ex.getMessage());
        }
    }
}
