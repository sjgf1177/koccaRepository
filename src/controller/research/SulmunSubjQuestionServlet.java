//**********************************************************
//1. 제      목: 과정설문 문제 관리
//2. 프로그램명: SulmunSubjQuestionServlet.java
//3. 개      요:
//4. 환      경: JDK 1.3
//5. 버      젼: 0.1
...
import com.credu.research.SulmunSubjQuestionBean;
...
@WebServlet("/servlet/controller.research.SulmunSubjQuestionServlet")
public class SulmunSubjQuestionServlet extends HttpServlet implements Serializable {
    /**
    ...
    */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
            ...
            if (!AdminUtil.getInstance().checkRWRight("SulmunSubjQuestionServlet", v_process, out, box)) {
                    return;
            }

			if (v_process.equals("SulmunQuestionListPage")) {                //과정설문 문제 리스트
                this.performSulmunQuestionListPage(request, response, box, out);
            } else if (v_process.equals("SulmunQuestionInsertPage")) {              //과정설문 문제 등록 페이지
                this.performSulmunQuestionInsertPage(request, response, box, out);
            } else if (v_process.equals("SulmunQuestionInsertS")) {              //과정설문 문제 등록 페이지
                this.performSulmunQuestionInsertS(request, response, box, out);
            } else if (v_process.equals("SulmunQuestionUpdatePage")) {              //과정설문 문제 수정 페이지
                this.performSulmunQuestionUpdatePage(request, response, box, out);
            } else if (v_process.equals("SulmunQuestionUpdateS")) {              //과정설문 문제 수정 페이지
                this.performSulmunQuestionUpdateS(request, response, box, out);
            } else if (v_process.equals("SulmunQuestionInsert")) {                  //과정설문 문제 등록할때
                this.performSulmunQuestionInsert(request, response, box, out);
            } else if (v_process.equals("SulmunQuestionUpdate")) {                  //과정설문 문제 수정하여 저장할때
                this.performSulmunQuestionUpdate(request, response, box, out);
            } else if (v_process.equals("SulmunQuestionDelete")) {                  // 과정설문 문제 삭제할때
                this.performSulmunQuestionDelete(request, response, box, out);
            } else if (v_process.equals("SulmunQuestionPoolPage")) {              //평가 문제 풀 페이지
                this.performSulmunQuestionPoolPage(request, response, box, out);
            } else if (v_process.equals("QuestionPoolListPage")) {              //평가 문제 풀 페이지
                this.performQuestionPoolListPage(request, response, box, out);
            } else if (v_process.equals("SulmunQuestionInsertPool")) {              //평가 문제 풀 등록
                this.performSulmunQuestionInsertPool(request, response, box, out);
            } 
        }catch(Exception ex) {
    ...
    */
    public void performSulmunQuestionListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
			...
			String v_return_url = "/learn/admin/research/za_SulmunSubjQuestion_L.jsp";
                        
			SulmunSubjQuestionBean bean = new SulmunSubjQuestionBean();
    ...
    */
	...
	public void performSulmunQuestionInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
  			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/research/za_SulmunSubjQuestion_I.jsp";
    ...
    */
    public void performSulmunQuestionInsertS(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
  			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/research/za_SulmunSubjQuestion_I2.jsp";
    ...
    */
    public void performSulmunQuestionUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/research/za_SulmunSubjQuestion_U.jsp";
    ...
    */
	...
	public void performSulmunQuestionUpdateS(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/research/za_SulmunSubjQuestion_U2.jsp";
    ...
    */
    public void performSulmunQuestionInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try{
			String v_url  = "/servlet/controller.research.SulmunSubjQuestionServlet";
    ...
    */
    ...
    @return void
    */
    public void performSulmunQuestionPoolPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/research/za_SulmunSubjQuestionPool_I.jsp";
                        
			SulmunSubjQuestionBean bean = new SulmunSubjQuestionBean();
			ArrayList list1 = bean.selectQuestionPool(box);
			request.setAttribute("SulmunQuestionPool", list1);
    ...
    */
    public void performQuestionPoolListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            request.setAttribute("SulmunQuestionPool", list);
    ...
    */
    @SuppressWarnings("unchecked")
	public void performSulmunQuestionInsertPool(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try{
			String v_url  = "/servlet/controller.research.SulmunSubjQuestionServlet";
			...
			String v_msg = "";
			box.put("p_process", "SulmunQuestionPoolPage");
			box.put("p_action",  "go");
            ...
            ErrorManager.getErrorStackTrace(ex, out);
            throw new Exception("performSulmunQuestionInsertPool()\r\n" + ex.getMessage());
        }
    }
