//**********************************************************
//1. 제      목: 과정설문 문제 관리
//2. 프로그램명: SulmunCPQuestionServlet.java
//3. 개      요:
//4. 환      경: JDK 1.3
//5. 버      젼: 0.1
...
import com.credu.research.SulmunCpQuestionBean;
 ...
 */
@WebServlet("/servlet/controller.research.SulmunCPQuestionServlet")
public class SulmunCPQuestionServlet extends HttpServlet implements Serializable {
    /**
    ...
    */
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
            ...
            if (!AdminUtil.getInstance().checkRWRight("SulmunCPQuestionServlet", v_process, out, box)) {
                    return;
            }
    ...
    */
    public void performSulmunQuestionListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
			...
			String v_return_url = "/learn/admin/research/za_SulmunCpQuestion_L.jsp";                
                        
			SulmunCpQuestionBean bean = new SulmunCpQuestionBean();
    ...
    */
    public void performSulmunQuestionInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
  			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/research/za_SulmunCpQuestion_I.jsp";
    ...
    //    try {
  	//		request.setAttribute("requestbox", box);            
	//		String v_return_url = "/learn/admin/research/za_SulmunCpQuestion_I2.jsp";
    //                    
	//		ScaleBean sbean = new ScaleBean();
	//		ArrayList list1 = sbean.selectScaleGubunExample(box); 
	//		request.setAttribute("ScaleQuestionExampleData", list1);
    ...
    */
    public void performSulmunQuestionUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/research/za_SulmunCpQuestion_U.jsp";
    ...
    //    try {
	//		request.setAttribute("requestbox", box);            
	//		String v_return_url = "/learn/admin/research/za_SulmunCpQuestion_U2.jsp";
    //
   	//		SulmunCpQuestionBean bean = new SulmunCpQuestionBean();
    ...
    */
    public void performSulmunQuestionInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try{
			String v_url  = "/servlet/controller.research.SulmunCPQuestionServlet";
