//**********************************************************
//1. 제      목: 일반설문 Servlet
//2. 프로그램명: SulmunCommonPaperServlet.java
//3. 개      요:
//4. 환      경: JDK 1.3
//5. 버      젼: 0.1
//6. 작      성: lyh
 ...
 */
@WebServlet("/servlet/controller.research.SulmunCommonPaperServlet")
public class SulmunCommonPaperServlet extends HttpServlet implements Serializable {
	/**
	...
	*/    
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
		...
		try {
			...
			if (!AdminUtil.getInstance().checkRWRight("SulmunCommonPaperServlet", v_process, out, box)) {
					return; 
			}
	...
	*/		
	public void performSulmunPaperListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
		try {     
			...
			String v_return_url = "/learn/admin/research/za_SulmunCommonPaper_L.jsp";
	...
	*/	
	public void performSulmunPaperInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
		try {     
			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/research/za_SulmunCommonPaper_I.jsp";
	...
	*/	
	public void performSulmunPaperUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
		try {     
			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/research/za_SulmunCommonPaper_U.jsp";
                        
			SulmunCommonPaperBean bean = new SulmunCommonPaperBean();
			ArrayList list1 = bean.selectQuestionList(box);
			request.setAttribute("SulmunCommonQuestionList", list1);
			
			ArrayList list2 = bean.selectPaperQuestionList(box);
			request.setAttribute("SulmunCommonPaperQuestionList", list2);
	...
	*/	
	public void performSulmunPaperInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
		try{                
			String v_url  = "/servlet/controller.research.SulmunCommonPaperServlet";
	...
	*/		
	public void performSulmunPaperPreviewPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
		try {     
			request.setAttribute("requestbox", box);            
		    String v_return_url = "/learn/admin/research/za_SulmunCommonPaperPreview.jsp";
