...
@WebServlet("/servlet/controller.research.KSulmunCommonUserServlet")
public class KSulmunCommonUserServlet extends HttpServlet implements Serializable {
    /**
     * 
     */
    private static final long serialVersionUID = -1116322860453947686L;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
            ...
            } else if (v_process.equals("SulmunUserResultInsert")) { //일반설문 결과등록
    ...
    public void performSulmunUserListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            ArrayList<DataBox> list1 = bean1.SelectUserList(box);
    ...
    public void performSulmunUserPaperListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            request.setAttribute("SulmunPaperData", dbox1); // 풀기문제리스트
    ...
    public void performSulmunUserResultInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            String v_url = "/servlet/controller.research.SulmunCommonUserServlet";
