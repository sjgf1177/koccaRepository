//**********************************************************
//1. 제      목: 
//2. 프로그램명: SulmunTargetResultServlet.java
//3. 개      요:
//4. 환      경: JDK 1.3
//5. 버      젼: 0.1
...
import com.credu.research.SulmunTargetResultBean;
 ...
 */
@WebServlet("/servlet/controller.research.SulmunTargetResultServlet")
public class SulmunTargetResultServlet extends HttpServlet implements Serializable {
	/**
	...
	*/    
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
		...
		try {
			...
			if (!AdminUtil.getInstance().checkRWRight("SulmunTargetResultServlet", v_process, out, box)) {
					return; 
			}
  ...
  */	
	public void performSulmunResultPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
		try {     
			...
			String v_return_url = "/learn/admin/research/za_SulmunTargetResult_L.jsp";
  ...
  */	
	public void performSulmunResultExcelPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
		try {     
			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/research/za_SulmunTargetResult_E.jsp";
  ...
  */	
	public void performSulmunDetailResultExcelPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
		try {     
			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/research/za_SulmunTargetDetailResult_E.jsp";
