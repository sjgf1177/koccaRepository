 ...
 */
@WebServlet("/servlet/controller.research.KSulmunTargetUserServlet")
public class KSulmunTargetUserServlet extends HttpServlet implements Serializable {
    /**
     * 
     */
    private static final long serialVersionUID = 7552524140278655584L;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
            ...
            } else if (v_process.equals("SulmunUserResultInsert")) { //대상자설문 결과 등록
                this.performSulmunUserResultInsert(request, response, box, out);
            } else if (v_process.equals("SulmunUserResultInsert2")) { //대상자설문
    ...
    public void performSulmunUserResultInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            // String v_url = "/servlet/controller.research.KSulmunTargetUserServlet";
