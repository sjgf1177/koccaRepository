//**********************************************************
//1. 제      목: 가입경로 설문 문제지관리 Servlet
//2. 프로그램명: SulmunRegistPaperServlet.java
//3. 개      요:
//4. 환      경: JDK 1.3
//5. 버      젼: 0.1
//6. 작      성: lyh
 ...
 */
@WebServlet("/servlet/controller.research.SulmunRegistPaperServlet")
public class SulmunRegistPaperServlet extends HttpServlet implements Serializable {
    /**
     * 
     */
    private static final long serialVersionUID = 8314619857938872814L;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
            ...
            if (!AdminUtil.getInstance().checkRWRight("SulmunRegistPaperServlet", v_process, out, box)) {
                return;
            }
    ...
    public void performSulmunPaperListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            String v_return_url = "/learn/admin/research/za_SulmunRegistPaper_L.jsp";
    ...
    public void performSulmunPaperInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            request.setAttribute("requestbox", box);
            String v_return_url = "/learn/admin/research/za_SulmunRegistPaper_I.jsp";
    ...
    public void performSulmunPaperUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            request.setAttribute("requestbox", box);
            String v_return_url = "/learn/admin/research/za_SulmunRegistPaper_U.jsp";

            SulmunRegistPaperBean bean = new SulmunRegistPaperBean();
            ArrayList<DataBox> list1 = bean.selectQuestionList(box);
            request.setAttribute("SulmunRegistQuestionList", list1);

            ArrayList<DataBox> list2 = bean.selectPaperQuestionList(box);
            request.setAttribute("SulmunRegistPaperQuestionList", list2);
    ...
    public void performSulmunPaperInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            String v_url = "/servlet/controller.research.SulmunRegistPaperServlet";
    ...
    public void performSulmunPaperPreviewPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            request.setAttribute("requestbox", box);
            String v_return_url = "/learn/admin/research/za_SulmunRegistPaperPreview.jsp";
