...
@WebServlet("/servlet/controller.course.CourseKyowonServlet")
public class CourseKyowonServlet extends HttpServlet implements Serializable {
    ...
    */
    public void performSubjectPreviewPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out)
        ...
        try {
            ...
            // 과정차수 리스트
            ArrayList list3 = bean.selectSubjSeqList(box);
            request.setAttribute("subjseqList", list3);

            if(v_select.equals("ON")){         //사이버 과정인 경우 일차리스트
                ArrayList list4 = bean.selectLessonList(box);
                request.setAttribute("lessonList", list4);
                v_url= "/learn/user/game/kyowon/gu_CourseIntroPreviewON.jsp";
            }else if(v_select.equals("OFF")){  //집합 과정인 경우 강좌리스트
                ArrayList list5 = bean.selectLectureList(box);
                request.setAttribute("lectureList", list5);
    ...
    */
    ...
    throws Exception {
    	try {
			...
			if( v_gubun.equals("1") ) v_url= "/learn/user/game/course/gu_SubjectIntro1.jsp";
			if( v_gubun.equals("2") ) v_url= "/learn/user/game/course/gu_SubjectIntro2.jsp";
			if( v_gubun.equals("3") ) v_url= "/learn/user/game/course/gu_SubjectIntro3.jsp";
    ...
    @return void
    */
    public void performKyowonSub(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out)
    throws Exception {
    	try {
			request.setAttribute("requestbox", box);
    	    String v_url= "";
			...
			if( v_gubun.equals("1") ) v_url= "/learn/user/game/kyowon/kyowon_sub1.jsp";
			if( v_gubun.equals("2") ) v_url= "/learn/user/game/kyowon/kyowon_sub2.jsp";
			if( v_gubun.equals("3") ) v_url= "/learn/user/game/kyowon/kyowon_sub3.jsp";
			if( v_gubun.equals("4") ) v_url= "/learn/user/game/kyowon/kyowon_sub4.jsp";
			if( v_gubun.equals("5") ) v_url= "/learn/user/game/kyowon/kyowon_sub5.jsp";
			if( v_gubun.equals("6") ) v_url= "/learn/user/game/kyowon/kyowon_sub6.jsp";
			if( v_gubun.equals("7") ) v_url= "/learn/user/game/kyowon/kyowon_sub7.jsp";
