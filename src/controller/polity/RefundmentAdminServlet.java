//*********************************************************
//1. 제      목: 행정서비스
//2. 프로그램명: PolityAdminServlet.java
//3. 개      요: 행정서비스 servlet
//4. 환      경: JDK 1.3
//5. 버      젼: 1.0
...
@WebServlet("/servlet/controller.polity.RefundmentAdminServlet")
public class RefundmentAdminServlet extends javax.servlet.http.HttpServlet implements Serializable {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
            ...
            } else if (v_process.equals("RefundmentAdminInsert")) { //  환불 처리
                this.performRefundmentAdminInsert(request, response, box, out);
            }
    ...
    public void performRefundmentInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out)
        ...
        try {
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/user/game/course/gu_Refundment_I.jsp");
            rd.forward(request, response);

            Log.info.println(this, box, "Dispatch to /learn/user/game/course/gu_Refundment_I.jsp");
     ...
     **/
    @SuppressWarnings("unchecked")
    public void performRefundmentAdminInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out)
            throws Exception {
        try {
            String v_url = "/servlet/controller.polity.RefundmentAdminServlet";
            String v_msg = "";

            RefundmentAdminBean bean = new RefundmentAdminBean();
            int isOk = bean.RefundmentAdminInsert(box);
