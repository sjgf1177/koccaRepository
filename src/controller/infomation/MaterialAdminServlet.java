...
@WebServlet("/servlet/controller.infomation.MaterialAdminServlet")
public class MaterialAdminServlet extends javax.servlet.http.HttpServlet implements Serializable {
