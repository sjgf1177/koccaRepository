...
@WebServlet("/servlet/controller.infomation.RoomManagerAdminServlet")
public class RoomManagerAdminServlet extends javax.servlet.http.HttpServlet implements Serializable {
