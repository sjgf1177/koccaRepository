...
import com.credu.infomation.GalaryBean;
...
@WebServlet("/servlet/controller.infomation.GalaryAdminServlet")
public class GalaryAdminServlet extends javax.servlet.http.HttpServlet implements Serializable {
    ...
    */
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
            ...
            if (!AdminUtil.getInstance().checkRWRight("GalaryAdminServlet", v_process, out, box)) {
                return;
            }
    ...
    */
    public void performSelectView(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            GalaryBean bean = new GalaryBean();
            ...
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/admin/infomation/za_galary_R.jsp");
    ...
    */
    public void performInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/admin/infomation/za_galary_I.jsp");
            rd.forward(request, response);
    ...
    */
    public void performInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            String v_msg = "";
            String v_url = "/servlet/controller.infomation.GalaryAdminServlet";
    ...
    */
    public void performUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/admin/infomation/za_galary_U.jsp");
            rd.forward(request, response);
    ...
    */
    public void performSelectList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/admin/infomation/za_galary_L.jsp");
            rd.forward(request, response);
