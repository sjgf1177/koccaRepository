/**
*외주관리시스템의 자료실을 제어하는 서블릿
*<p>제목:CpMateriaServlet.java</p>
*<p>설명:외주관리시스템Materia서블릿</p>
...
import com.credu.cp.CpMateriaBean;
...
@WebServlet("/servlet/controller.cp.CpMateriaServlet")
public class CpMateriaServlet extends javax.servlet.http.HttpServlet {
    ...
    */
    public void performSelectList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {        
            ...
            CpMateriaBean materia = new CpMateriaBean();
            ...
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/user/zu_CpMateria_L.jsp");
			System.out.println("cpmateria_l.jsp로 forward하기");
    ...
    */
    public void performSelect(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/user/zu_CpMateria_R.jsp");
            rd.forward(request, response);
            
            Log.info.println(this, box, "Dispatch to /cp/user/zu_CpMateria_R.jsp");
    ...
    */
    public void performInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/user/zu_CpMateria_I.jsp");
			System.out.println("zu_CpMateria_I.jsp로 forward");
            rd.forward(request, response);
    ...
    */
    public void performInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {       
            ...
            String v_msg = "";
            String v_url = "/servlet/controller.cp.CpMateriaServlet";
            box.put("p_process", "");
    ...
    */
    public void performUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {              
            ...
            ServletContext sc = getServletContext();     
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/user/zu_CpMateria_U.jsp");
            rd.forward(request, response);
