/**
*외주관리시스템의 Sw자료실을 제어하는 서블릿
*<p>제목:CpSwServlet1.java</p>
*<p>설명:외주관리시스템Sw서블릿</p>
...
@WebServlet("/servlet/controller.cp.CpSwServlet1")
public class CpSwServlet1 extends javax.servlet.http.HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
	   ...
	   v_canDelete = BulletinManager.isAuthority(box, box.getString("p_canDelete"));
            ...
            if(v_process.equals("insertPage")) {       //  등록페이지로 이동할때
				...
				System.out.println("//      조회할때==v_canRead" +v_canRead);
	...
	*/
    public void performSelectList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {        
            ...
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/user/zu_CpSw_L.jsp");
			System.out.println("cpsw_l.jsp로 forward하기");
	...
	*/
    public void performSelect(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/user/zu_CpSw_R.jsp");
            rd.forward(request, response);
            
            Log.info.println(this, box, "Dispatch to /cp/user/zu_CpSw_R.jsp");
	...
	*/
    public void performInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/user/zu_CpSw_I.jsp");
			System.out.println("zu_CpSw_I.jsp로 forward");
            rd.forward(request, response);
	...
	*/
    public void performInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {       
            ...
            String v_msg = "";
            String v_url = "/servlet/controller.cp.CpSwServlet1";
            box.put("p_process", "");
	...
	*/
    public void performUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {              
            ...
            ServletContext sc = getServletContext();     
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/user/zu_CpSw_U.jsp");
            rd.forward(request, response);
