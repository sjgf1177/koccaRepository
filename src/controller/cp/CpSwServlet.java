...
@WebServlet("/servlet/controller.cp.CpSwServlet")
public class CpSwServlet extends javax.servlet.http.HttpServlet {
	...
	*/
    public void performInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {       
            ...
            String v_msg = "";
            String v_url = "/servlet/controller.cp.CpSwServlet";
            box.put("p_process", "");
