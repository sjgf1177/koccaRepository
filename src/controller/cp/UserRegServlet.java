//**********************************************************
//  1. 제      목: 생산교육센터 가족회원가입 서블릿
//  2. 프로그램명 : UserRegServlet.java
//  3. 개      요: 생산교육센터 가족회원가입 프로그램
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 이창훈 2005. 2.  15
//  7. 수     정1:
...
/**
*생산교육센터 가족회원가입
*<p>제목:UserRegServlet.java</p>
*<p>설명:생산교육센터 가족회원가입 서블릿</p>
...
@WebServlet("/servlet/controller.cp.UserRegServlet")
public class UserRegServlet extends javax.servlet.http.HttpServlet {
	...
	*/  
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
			...
			//if (!AdminUtil.getInstance().checkRWRight("UserRegServlet", v_process, out, box)) {
			//	return; 
			//}
    ...
    */
	public void performCheck(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {        
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/user/zu_usercheck.jsp");
            rd.forward(request, response);
