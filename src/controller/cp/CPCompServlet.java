...
*@version 1.0
*/
@WebServlet("/servlet/controller.cp.CPCompServlet")
public class CPCompServlet extends javax.servlet.http.HttpServlet {
	/**
	...
	*/
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
			...
			if (!AdminUtil.getInstance().checkRWRight("CPCompServlet", v_process, out, box)) {
				return;
			}
            ...
            else if(v_process.equals("compSelectExcel")) {   //업체 레포트
            	this.performCompSelectExcel(request, response, box, out);
            }
            else if(v_process.equals("replayPage")) {   //업체 레포트
            	this.performCompReplayPage(request, response, box, out);
            }
    ...
    */
    public void performList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/admin/za_cpcomp_L.jsp");
    ...
    */
     public void performInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            String v_msg = "";
            String v_url = "/servlet/controller.cp.CPCompServlet";
            box.put("p_process", "");
    ...
    */
    ...
    @return void
    */
    public void performCompSelectExcel(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {

            request.setAttribute("requestbox", box);
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/admin/za_cpcomp_E.jsp");
            rd.forward(request, response);
            Log.info.println(this, box, "Dispatch to /cp/admin/za_cpcomp_E.jsp");
    ...
    @return void
    */
    public void performCompReplayPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
