/**
*외주관리시스템의 게시판을 제어하는 서블릿
*<p>제목:CpBoardServlet.java</p>
*<p>설명:외주관리시스템Board서블릿</p>
...
@WebServlet("/servlet/controller.cp.CpPdsServlet")
public class CpPdsServlet extends javax.servlet.http.HttpServlet {
...
//	   v_canAppend = 
		   BulletinManager.isAuthority(box, box.getString("p_canAppend"));
//	   v_canModify = 
		   BulletinManager.isAuthority(box, box.getString("p_canModify"));
//	   v_canDelete = 
		   BulletinManager.isAuthority(box, box.getString("p_canDelete"));
    ...
    */
    public void performSelectList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {        
            ...
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/admin/za_cpPdsAdmin_L.jsp");
    ...
    */
    public void performSelect(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {       
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/cp/admin/za_cpPdsAdmin_R.jsp");
            rd.forward(request, response);
            
            Log.info.println(this, box, "Dispatch to /cp/admin/za_cpPdsAdmin_R.jsp");
