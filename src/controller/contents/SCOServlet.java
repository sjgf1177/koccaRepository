...
import com.credu.contents.SCOBean;
import com.credu.contents.SCOData;
...
@WebServlet("/servlet/controller.contents.SCOServlet")
public class SCOServlet extends HttpServlet implements Serializable {
	...
	*/    
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
		...
		try {
			...
			if (!AdminUtil.getInstance().checkRWRight("SCOServlet", v_process, out, box)) {
				return; 
			}
			///////////////////////////////////////////////////////////////////
	...
	*/
	public void performListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
		try {     
			...
			String v_return_url = "/learn/admin/contents/za_SCO_L.jsp";
	...
	*/
	...
	public void performInsertSco(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
		try {     
			...
			request.setAttribute("requestbox", box);            
			String v_return_url = "/learn/admin/contents/za_SCOIN_L.jsp";	
	...
	*/
	public void performInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
		...
		try{                
			request.setAttribute("requestbox", box);            
			String v_url = "/learn/admin/contents/za_SCO_I.jsp";
	...
	**/
	public void performInsertSave(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
		throws Exception {   
		try{                
			String v_url  = "/servlet/controller.contents.SCOServlet";
	...
	*/
	...
	public void performUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
		...
		try{
		    ...
		    v_url = "/learn/admin/contents/za_SCO_U.jsp";			    
			            
			SCOBean bean = new SCOBean();
			SCOData data = bean.SelectObjectData(box);	//Object 정보
	...
	*/
	...
	public void performUpdateViewPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
		...
		try{
		    ...
		    v_url = "/learn/admin/contents/scorm/za_SCO_Contents_L.jsp";			    
	...
	**/
	public void performScoPackageList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
		...
		try{					
			...
			String v_url = "/learn/admin/contents/za_SCOPackage_L.jsp";	
	...
	*/
	...
	public void performContentList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
		try {     
			...
			if (list1.size() > 0 ) {
				v_return_url = "/learn/admin/contents/za_SCOContent_L.jsp";				
				request.setAttribute("ScoObjectList", list1);
			} else {
			    v_return_url = "/learn/admin/contents/za_SCO_L.jsp";	
				box.put("p_process", "listPage");
			} 
