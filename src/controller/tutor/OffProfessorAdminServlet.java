...
@WebServlet("/servlet/controller.tutor.OffProfessorAdminServlet")
public class OffProfessorAdminServlet extends javax.servlet.http.HttpServlet implements Serializable {
