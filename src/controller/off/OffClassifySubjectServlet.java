...
@WebServlet("/servlet/controller.off.OffClassifySubjectServlet")
public class OffClassifySubjectServlet extends javax.servlet.http.HttpServlet implements Serializable {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
		...
		try {
			...
			if (!AdminUtil.getInstance().checkRWRight("OffClassifySubjectServlet", v_process, out, box)) {
				return;
			}
	...
	public void performListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
		try {
			...
			String v_return_url = "/learn/admin/off/za_offClassifySubject_L.jsp";

			OffClassifySubjectBean bean = new OffClassifySubjectBean();
	...
	throws Exception {
		try{
			request.setAttribute("requestbox", box);
			String v_return_url = "/learn/admin/off/za_offClassifySubject_I.jsp";
	...
	throws Exception {
		try{
			String v_url  = "/servlet/controller.off.OffClassifySubjectServlet";
	...
	throws Exception {
		try{
			request.setAttribute("requestbox", box);
			String v_url = "/learn/admin/off/za_offClassifySubject_U.jsp";
