//**********************************************************
//  1. 제      목: 사이트맵
//  2. 프로그램명 : HomePageSiteMapServlet.java
...
@WebServlet("/servlet/controller.homepage.HomePageSiteMapServlet")
public class HomePageSiteMapServlet extends javax.servlet.http.HttpServlet {
    ...
    */
    public void performListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {            
            ...
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/user/game/service/gu_siteMap.jsp");
            rd.forward(request, response);

            Log.info.println(this, box, "Dispatch to /learn/user/game/service/gu_siteMap.jsp");
        }catch (Exception ex) {            
            ErrorManager.getErrorStackTrace(ex, out);
