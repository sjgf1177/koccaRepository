...
//2. 프로그램명: KHomeNoticeServlet.java
...
@WebServlet("/servlet/controller.homepage.KHomeNoticeServlet")
public class KHomeNoticeServlet extends javax.servlet.http.HttpServlet {
...
try {
	request.setAttribute("requestbox", box);
	  ...
	  String v_return_url = "/learn/user/kocca/common/ku_Notice_L.jsp";
  ...
  Log.info.println(this, box, "Dispatch to /learn/user/kocca/common/ku_Notice_L.jsp");
}catch (Exception ex) {
  ErrorManager.getErrorStackTrace(ex, out);
...
public void performMainListPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
  try {
      ...
      String v_url = "";
      v_url = "/learn/user/kocca/hompage/Notice.jsp";
	...
	int v_seq= box.getInt("p_seq");
	  ...
	  HomeNoticeBean bean = new HomeNoticeBean();
          ...
          if (tabseq == 0) {
	        ...
	        ArrayList list1 = bean.selectDirectList(box);
	        request.setAttribute("selectNoticeList", list1);
...
try {
  ...
  ServletContext    sc = getServletContext();
  RequestDispatcher rd = sc.getRequestDispatcher("/learn/user/kocca/common/ku_Notice_R.jsp");
  rd.forward(request, response);

  Log.info.println(this, box, "Dispatch to /learn/user/kocca/common/ku_Notice_R.jsp");
}catch (Exception ex) {
  ErrorManager.getErrorStackTrace(ex, out);
