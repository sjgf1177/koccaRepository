...
@WebServlet("/servlet/controller.homepage.MemberJoinServlet")
public class MemberJoinServlet extends javax.servlet.http.HttpServlet implements Serializable {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
            ...
            if (v_process.equals("join")) {
                ...
                this.performUser(request, response, box, out);
    ...
    public void performJoin(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            String v_url = "";
            v_url = "/learn/user/game/member/gu_Member.jsp";
            box.put("p_process", "");
    ...
    public void performCheckResno(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            if (is_Ok == 0) {
                ...
                request.setAttribute("requestbox", box); //      명시적으로 box 객체를 넘겨준다
                ServletContext sc = getServletContext();
                RequestDispatcher rd = sc.getRequestDispatcher("/learn/user/game/member/gu_MemberJoin.jsp");
                rd.forward(request, response);
            } else {
                v_msg = "이미 가입된 회원입니다";
    ...
    public void performCheckID(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            String v_msg = "";
            String v_url = "/learn/user/game/member/gu_idCheck.jsp";
            // AlertManager alert = new AlertManager();
    ...
    public void performJoinOk(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            if (is_Ok == 1) {
                 ...
                 * 넘겨준다 ServletContext sc = getServletContext();
                 * RequestDispatcher rd = sc.getRequestDispatcher(v_url);
                 * rd.forward(request, response);
                 */
            } else {
     ...
     * @return void
     */
    public void performUser(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            String v_url = "";
            v_url = "/learn/user/game/member/gu_UserAgree.jsp";
    ...
    public void performPersonal(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            String v_url = "";
            v_url = "/learn/user/game/member/gu_Personal.jsp";
     ...
     * @return void
     */
    public void performFirstLoginPagePre(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out)
            throws Exception {
        try {
            request.setAttribute("requestbox", box); //      명시적으로 box 객체를 넘겨준다
