//**********************************************************
//  1. 제      목: S/W게시판을 제어하는 서블릿
//  2. 프로그램명 : SoftwareBoardServlet.java
//  3. 개      요: S/W게시판의 페이지을 제어한다
//  4. 환      경: JDK 1.3
//  5. 버      젼: 1.0
//  6. 작      성: 2004.1
//  7. 수      정:
...
import com.credu.common.MileageManager;
...
@WebServlet("/servlet/controller.homepage.SoftwareBoardServlet")
public class SoftwareBoardServlet extends javax.servlet.http.HttpServlet {

    /**
     * 
     */
    private static final long serialVersionUID = -3010553610650759789L;
    ...
    public void performSelectList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            request.setAttribute("selectSoftwareBoardList", list);

            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/user/homepage/zu_SoftwareBoard_L.jsp");
            rd.forward(request, response);

            Log.info.println(this, box, "Dispatch to /learn/user/homepage/zu_SoftwareBoard_L.jsp");
    ...
    public void performSelect(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            request.setAttribute("selectSoftwareBoard", dbox);

            ArrayList<DataBox> list = bean.selectBoardList(box);
            request.setAttribute("selectSoftwareBoardList", list);

            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/user/homepage/zu_SoftwareBoard_R.jsp");
            rd.forward(request, response);

            Log.info.println(this, box, "Dispatch to /learn/user/homepage/zu_SoftwareBoard_R.jsp");
    ...
    public void performInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/user/homepage/zu_SoftwareBoard_I.jsp");
            rd.forward(request, response);

            Log.info.println(this, box, "Dispatch to /learn/user/homepage/zu_SoftwareBoard_I.jsp");
    ...
    public void performInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            String v_msg = "";
            String v_url = "/servlet/controller.homepage.SoftwareBoardServlet";
            box.put("p_process", "");
            ...
            if (isOk > 0) {
                ...
                MileageManager.insertMileage(v_code, s_userid); // 마일리지 작성
                /* ================ 마일리지 등록 시작 ============================ */
            ...
            Log.info.println(this, box, v_msg + " on SoftwareBoardServlet");
        } catch (Exception ex) {
            ErrorManager.getErrorStackTrace(ex, out);
    ...
    public void performUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/user/homepage/zu_SoftwareBoard_U.jsp");
            rd.forward(request, response);

            Log.info.println(this, box, "Dispatch to /learn/user/homepage/zu_SoftwareBoard_U.jsp");
    ...
    public void performReplyPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/user/homepage/zu_SoftwareBoard_A.jsp");
            rd.forward(request, response);

            Log.info.println(this, box, "Dispatch to /learn/user/homepage/zu_SoftwareBoard_A.jsp");
