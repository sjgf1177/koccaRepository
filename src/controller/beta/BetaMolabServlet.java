/**
*베타테스트시스템의 노동부자료실을 제어하는 서블릿
*<p>제목:BetaMolabServlet.java</p>
*<p>설명:베타테스트시스템Molab서블릿</p>
...
import com.credu.beta.BetaMolabBean;
...
@WebServlet("/servlet/controller.beta.BetaMolabServlet")
public class BetaMolabServlet extends javax.servlet.http.HttpServlet {
    ...
    */
    public void performSelectList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {        
            ...
            BetaMolabBean molab = new BetaMolabBean();
            
            ArrayList list = molab.selectPdsList(box);
            
            request.setAttribute("selectPdsList", list);
                      
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaMolab_L.jsp");
			System.out.println("zu_BetaMolab_L.jsp로 forward하기");
    ...
    */
    public void performSelect(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {            
            ...
            DataBox dbox = molab.selectPds(box);

            request.setAttribute("selectPds", dbox);
            
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaMolab_R.jsp");
            rd.forward(request, response);
            
            Log.info.println(this, box, "Dispatch to /beta/user/zu_BetaMolab_R.jsp");
    ...
    */
    public void performInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaMolab_I.jsp");
			System.out.println("zu_BetaMolab_I.jsp로 forward");
            rd.forward(request, response);
    ...
    */
    public void performInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {       
            ...
            int isOk = molab.insertPds(box);
            
            String v_msg = "";
            String v_url = "/servlet/controller.beta.BetaMolabServlet";
            box.put("p_process", "");
    ...
    */
    public void performUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {              
            ...
            ServletContext sc = getServletContext();     
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaMolab_U.jsp");
            rd.forward(request, response);
