/**
*베타테스트시스템의 자료실을 제어하는 서블릿
*<p>제목:BetaMateriaServlet.java</p>
*<p>설명:베타테스트시스템Materia서블릿</p>
...
import com.credu.beta.BetaMateriaBean;
...
@WebServlet("/servlet/controller.beta.BetaMateriaServlet")
public class BetaMateriaServlet extends javax.servlet.http.HttpServlet {
    ...
    */
    public void performSelectList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {        
            ...
            BetaMateriaBean materia = new BetaMateriaBean();
            
            ArrayList list = materia.selectPdsList(box);
            
            request.setAttribute("selectPdsList", list);
                      
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaMateria_L.jsp");
			System.out.println("betamateria_l.jsp로 forward하기");
    ...
    */
    public void performSelect(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {            
            ...
            DataBox dbox = materia.selectPds(box);

            request.setAttribute("selectPds", dbox);
            
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaMateria_R.jsp");
            rd.forward(request, response);
            
            Log.info.println(this, box, "Dispatch to /beta/user/zu_BetaMateria_R.jsp");
    ...
    */
    public void performInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaMateria_I.jsp");
			System.out.println("zu_BetaMateria_I.jsp로 forward");
            rd.forward(request, response);
    ...
    */
    public void performInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {       
            ...
            int isOk = materia.insertPds(box);
            
            String v_msg = "";
            String v_url = "/servlet/controller.beta.BetaMateriaServlet";
            box.put("p_process", "");
    ...
    */
    public void performUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {              
            ...
            ServletContext sc = getServletContext();     
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaMateria_U.jsp");
            rd.forward(request, response);
    ...
    public void performUpdate(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
    	throws Exception {       
         try {                       
            ...
            int isOk = materia.updatePds(box);
    ...
    */
    ...
    public void performDelete(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {
            ...
            int isOk = materia.deletePds(box);
