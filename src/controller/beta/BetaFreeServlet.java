/**
*베타테스트시스템의 자유게시판을 제어하는 서블릿
*<p>제목:BetaFreeServlet.java</p>
*<p>설명:베타테스트시스템Free서블릿</p>
...
import com.credu.beta.BetaFreeBean;
...
@WebServlet("/servlet/controller.beta.BetaFreeServlet")
public class BetaFreeServlet extends javax.servlet.http.HttpServlet {
    ...
    */
    public void performSelectList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {        
            ...
            BetaFreeBean free = new BetaFreeBean();
            ...
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaFree_L.jsp");
			System.out.println("betafree_l.jsp로 forward하기");
    ...
    */
    public void performSelect(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaFree_R.jsp");
            rd.forward(request, response);
            
            Log.info.println(this, box, "Dispatch to /beta/user/zu_BetaFree_R.jsp");
    ...
    */
    public void performInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaFree_I.jsp");
			System.out.println("zu_BetaFree_I.jsp로 forward");
            rd.forward(request, response);
    ...
    */
    public void performInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {       
            ...
            String v_msg = "";
            String v_url = "/servlet/controller.beta.BetaFreeServlet";
            box.put("p_process", "");
    ...
    */
    public void performUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {              
            ...
            ServletContext sc = getServletContext();     
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaFree_U.jsp");
            rd.forward(request, response);
