/**
*베타테스트시스템의 서식자료실을 제어하는 서블릿
*<p>제목:BetaFormServlet.java</p>
*<p>설명:베타테스트시스템Form서블릿</p>
...
import com.credu.beta.BetaFormBean;
...
@WebServlet("/servlet/controller.beta.BetaFormServlet")
public class BetaFormServlet extends javax.servlet.http.HttpServlet {
    ...
    */
    public void performSelectList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {        
            ...
            BetaFormBean formboard = new BetaFormBean();
            ...
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaForm_L.jsp");
    ...
    */
    public void performSelect(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaForm_R.jsp");
            rd.forward(request, response);
            
            Log.info.println(this, box, "Dispatch to /beta/user/zu_BetaForm_R.jsp");
    ...
    */
    public void performInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaForm_I.jsp");
    ...
    */
    public void performInsert(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {       
            ...
            String v_msg = "";
            String v_url = "/servlet/controller.beta.BetaFormServlet";
            box.put("p_process", "");
    ...
    */
    public void performUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {              
            ...
            ServletContext sc = getServletContext();     
            RequestDispatcher rd = sc.getRequestDispatcher("/beta/user/zu_BetaForm_U.jsp");
            rd.forward(request, response);
