...
import com.credu.gatepage.GatePageNoticeAdminBean;
...
@WebServlet("/servlet/controller.gatepage.GatePageNoticeServlet")
    ...
    */
    public void performSelectList(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {        
            ...
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/admin/gatepage/za_GatepageNotice_L.jsp");
    ...
    */    
    public void performSelect(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/admin/gatepage/za_GatepageNotice_R.jsp");
            rd.forward(request, response);
    ...
    */    
    public void performInsertPage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) 
        ...
        try {            
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/admin/gatepage/za_GatepageNotice_I.jsp");
    ...
    */    
    public void performUpdatePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {       
        try {              
            ...
            ServletContext sc = getServletContext();     
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/admin/gatepage/za_GatepageNotice_U.jsp");
            rd.forward(request, response);
