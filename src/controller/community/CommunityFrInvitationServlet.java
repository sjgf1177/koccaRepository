...
//  2. 프로그램명 : CommunityFrInvitationServlet.java
...
public class CommunityFrInvitationServlet extends javax.servlet.http.HttpServlet {
    ...
    */
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
            ...
            } else if(v_process.equals("blankData")) {          //  등록처리
              this.performFrBlankData(request, response, box, out);
    ...
    */
    public void performmoFrWritePage(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out)
        ...
        try {
            ...
            ArrayList list = bean.selectMemberInvitation(box); 
            
            request.setAttribute("list", list);

            ServletContext    sc = getServletContext();
            RequestDispatcher rd = sc.getRequestDispatcher("/learn/user/community/zu_FrInvitation.jsp");
            rd.forward(request, response);

            Log.info.println(this, box, "Dispatch to /learn/user/community/zu_FrInvitation.jsp");
        }catch (Exception ex) {
            ErrorManager.getErrorStackTrace(ex, out);
    ...
    @return void
    */
    public void performFrBlankData(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out)
        throws Exception {
        try {
            request.setAttribute("requestbox", box);  
    ...
    */
    ...
    public void performInsertFrWriteData(HttpServletRequest request, HttpServletResponse response, RequestBox box, PrintWriter out) throws Exception {
        try {
            CommunityFrInvitationBean bean = new CommunityFrInvitationBean();

            int isOk = bean.sendInvitation(box);

            String v_msg = "";
            String v_url = "/servlet/controller.community.CommunityFrInvitationServlet";
